...
import static de.cron3x.dieacnocte.item.ItemRegister.EXAMPLE_ITEM;

// The value here should match an entry in the META-INF/mods.toml file
@Mod(DieAcNocteMod.MODID)
public class DieAcNocteMod
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "dieacnocte";
    ...
    public DieAcNocteMod(IEventBus modEventBus)
    {
