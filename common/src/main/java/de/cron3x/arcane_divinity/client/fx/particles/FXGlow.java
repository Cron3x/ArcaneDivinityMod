...
public class FXGlow extends TextureSheetParticle {
    private final float moteParticleScale;
    private final int moteHalfLife;

    public FXGlow(ClientLevel world, double d, double d1, double d2, double xSpeed, double ySpeed, double zSpeed,
    ...
    private static void beginRenderCommon(BufferBuilder bufferBuilder, TextureManager textureManager) {
        ...
        Services.PLATFORM.setFilterSave(tex, true, false);
    ...
    private static void endRenderCommon() {
        ...
        Services.PLATFORM.restoreLastFilter(tex);
